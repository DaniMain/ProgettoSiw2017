...
public final class load_002dauthor_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  private boolean _jspx_meth_form_form_0(PageContext _jspx_page_context)
    ...
    _jspx_th_form_form_0.setCommandName("autore");
  ...
  private boolean _jspx_meth_form_input_0(javax.servlet.jsp.tagext.JspTag _jspx_th_form_form_0, PageContext _jspx_page_context, int[] _jspx_push_body_count_form_form_0)
    ...
    _jspx_th_form_input_0.setDynamicAttribute(null, "type", new String("nome"));
    _jspx_th_form_input_0.setDynamicAttribute(null, "class", new String("form-control"));
    _jspx_th_form_input_0.setPath("nome");
    _jspx_th_form_input_0.setDynamicAttribute(null, "placeholder", new String("Nome"));
  ...
  private boolean _jspx_meth_form_input_1(javax.servlet.jsp.tagext.JspTag _jspx_th_form_form_0, PageContext _jspx_page_context, int[] _jspx_push_body_count_form_form_0)
    ...
    _jspx_th_form_input_1.setDynamicAttribute(null, "type", new String("cognome"));
    _jspx_th_form_input_1.setDynamicAttribute(null, "class", new String("form-control"));
    _jspx_th_form_input_1.setPath("cognome");
    _jspx_th_form_input_1.setDynamicAttribute(null, "placeholder", new String("Cognome"));
  ...
  private boolean _jspx_meth_form_input_2(javax.servlet.jsp.tagext.JspTag _jspx_th_form_form_0, PageContext _jspx_page_context, int[] _jspx_push_body_count_form_form_0)
    ...
    _jspx_th_form_input_2.setDynamicAttribute(null, "type", new String("nazione"));
    _jspx_th_form_input_2.setDynamicAttribute(null, "class", new String("form-control"));
    _jspx_th_form_input_2.setPath("nazione");
    _jspx_th_form_input_2.setDynamicAttribute(null, "placeholder", new String("Nazione"));
