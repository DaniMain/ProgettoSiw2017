	...
	<div id="myCarousel" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner" role="listbox">
			<div class="item active">
				<img class="first-slide" alt="l'ultima cena"
			...
			<div class="item">
				<img class="second-slide"
					src="http://aforismi.meglio.it/img/frasi/quadri.jpg"
					alt="notte stellata">
				<div class="container">
					<div class="carousel-caption">
			...
			<div class="item">
				<img class="third-slide"
					src="http://www.theartpostblog.com/wp-content/uploads/2016/05/monet-impressione-levar-del-sole.jpg"
					alt="Impressione al levar del sole">
				<div class="container">
					<div class="carousel-caption">
